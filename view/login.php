                ...
                <div class="col-md-12">
                    ...
                    <form action="../app/index.php?act=login" method="post" >
                        <div class="form-group <?php //echo (!empty($loginObj->username_msg)) ? 'has-error' : ''; ?>">
                            ...
                            <input type="text" name="username" class="form-control" value="<?php //echo $sporttb->category; ?>" required>
                        ...
                        <div class="form-group <?php //echo (!empty($loginObj->password_msg)) ? 'has-error' : ''; ?>">
                            ...
                            <input type="password" name="password" class="form-control" value="<?php //echo $sporttb->name; ?>" required>
